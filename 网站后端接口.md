...
url:/interface/memberCommentLogs/deleteMemberCommentLogsByCommentByCommentId
请求方式：POST
...
url:/interface/sms/sendCode?memberPhone=xxxxxxx
请求方式：Get
...
### 15.注册或登录（未注册时自动注册并登录返回用户信息，已经注册的直接登录返回用户信息）

url:/interface/member/registerAndLoginMemberWeb
请求方式：POST
...
| tagsIds               | String                   | 关键字标签id，多个用逗号分隔          |
